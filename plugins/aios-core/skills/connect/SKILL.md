...
הערה ל-Windows: הפקודות כאן רצות בתוך Git Bash (מותקן בשלב ההתקנה), ו-gws שומר את ההגדרות שלו תחת תיקיית הבית של המשתמש, כך ש-`~/.config/gws` נפתר נכון מתוך Git Bash.
